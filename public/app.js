...
function requestUserGeolocation() {
    ...
    function uploadCurrentPosition() {
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(
                async (position) => {
                    ...
                    console.log("Real coordinates updated:", realUserCoords);
                ...
                async (error) => {
                    console.warn("Geolocation permission denied or failed. Using municipality default with deterministic offset.", error);
    ...
    setInterval(uploadCurrentPosition, 4000);
}
